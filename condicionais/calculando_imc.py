...
if imc < 18.5:
    print(f'Seu IMC = {imc:.2f}, portanto você está abaixo do peso ideal');
elif imc < 25:
    print(f'Seu IMC = {imc:.2f}, portanto você está com peso normal');
elif imc >= 25:
    print(f'Seu IMC = {imc:.2f}, portanto você está acima do peso ideal');
else:
