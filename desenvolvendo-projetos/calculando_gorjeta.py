...
gorjeta = (porcentagem_gorjeta / 100) * total_conta

total = total_conta + gorjeta

print(f'O valor da gorjeta foi de: R${gorjeta}')
print(f'O valor total da conta é igual a: R${total}')